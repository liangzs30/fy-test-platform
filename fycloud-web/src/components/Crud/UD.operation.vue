<template>
  <div>
    <el-button v-permission="permission.edit" :loading="crud.status.cu === 2" :disabled="disabledEdit" size="mini" type="primary" style="background-color: #409EFF" icon="el-icon-edit" @click.stop="crud.toEdit(data)" />
