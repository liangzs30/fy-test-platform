 ...
 */
package fy.liangzs.modules.security.service;
...
import fy.liangzs.modules.security.service.dto.OnlineUserDto;
...
public class OnlineUserService {
    ...
    public List<OnlineUserDto> getAll(String username){
        ...
        for (String key : keys) {
            ...
            if (!onlineUserDto.getUserName().equals("execMachine")) {
