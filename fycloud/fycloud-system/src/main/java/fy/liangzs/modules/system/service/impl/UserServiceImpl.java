...
import fy.liangzs.modules.system.service.UserService;
import fy.liangzs.modules.system.service.dto.*;
import fy.liangzs.modules.system.service.mapstruct.UserLoginMapper;
import fy.liangzs.modules.system.service.mapstruct.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public PageResult<UserDto> queryAll(UserQueryCriteria criteria, Pageable pageable) {
        criteria.setUsername("execMachine");
    ...
    public void create(User resources) {
        ...
        projectService.saveLast(user.getId(), project.getId());
    }
